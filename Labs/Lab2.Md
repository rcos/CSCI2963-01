...
8.  Take 5 projects from http://rcos.io - create a table which project has which license. for example:

Website | License Present | License
---------|:----------|:-------
https://github.com/rcos/Observatory | Yes | Two Clause BD https://en.wikipedia.org/wiki/ISC_license
