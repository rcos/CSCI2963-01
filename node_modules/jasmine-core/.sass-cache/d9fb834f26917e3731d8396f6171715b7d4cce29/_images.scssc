...
@	;[o;	;i;	"backgrounds;
@	;"backgrounds;{ ;i;	["background:@prop_syntax:new;
@	:@children[ u;)Ã[o:Sass::Script::Operation
:@operand1o:Sass::Script::Variable	:
@linei :
...
[ u;)è[o:!Sass::Script::UnaryOperation	:
...
value;@;	"
value:@keywords{ ;{ ;ic;["-moz-border-image:@prop_syntax:new;@:@children[ u;)ã[o:Sass::Script::Variable	:
@lineid:
...
value;@;	"
value:@keywords{ ;{ ;id;["-webkit-border-image:@prop_syntax:new;@:@children[ u;)Ç[o:Sass::Script::Variable	:
@lineie:
...
:@operand1o:Sass::Script::Variable	:
@lineiÄ:
@name"$experimental-support-for-webkit:@options{ :@underscored_name"$experimental_support_for_webkit;iÄ;
@	:@operand2o:Sass::Script::Funcall
;iÄ;	"prefixed;
@	:
@args[o:Sass::Script::String	:
@type:identifier:@value"-webkit;iÄ;
@	o;	;iÄ;	"
value;
@	;"
value:@keywords{ :@operator:and0[o:Sass::Tree::PropNode:
...
value;
@	;"
value;{ ;iÄ;	["content:@prop_syntax:new;
@	:@children[ u;)[o:Sass::Script::Operation
:@operand1o:Sass::Script::Variable	:
@lineiÅ:
@name"#experimental-support-for-opera:@options{ :@underscored_name"#experimental_support_for_opera;iÅ;
@	:@operand2o:Sass::Script::Funcall
;iÅ;	"prefixed;
@	:
@args[o:Sass::Script::String	:
@type:identifier:@value"-o;iÅ;
@	o;	;iÅ;	"
value;
@	;"
value:@keywords{ :@operator:and0[o:Sass::Tree::PropNode:
...
value;
@	;"
value;{ ;iÅ;	["content:@prop_syntax:new;
@	:@children[ u;)[o:Sass::Script::Operation
:@operand1o:Sass::Script::Variable	:
@lineiÇ:
@name"!experimental-support-for-svg:@options{ :@underscored_name"!experimental_support_for_svg;iÇ;
@	:@operand2o:Sass::Script::Funcall
;iÇ;	"prefixed;
@	:
@args[o:Sass::Script::String	:
@type:identifier:@value"	-svg;iÇ;
@	o;	;iÇ;	"
value;
@	;"
value:@keywords{ :@operator:and0[o:Sass::Tree::PropNode:
...
value;
@	;"
value;{ ;iÇ;	["content:@prop_syntax:new;
@	:@children[ o;*;+i ;o;	;iÉ;"
value;	@;"
value;iÉ;["content;,;-;	@;
[ 